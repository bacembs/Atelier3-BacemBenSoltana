...
class ClubController extends AbstractController
{
    ...
    #[Route('/club/get/{nom}', name: 'app_name')]
    ...
    /*#[Route('/participer/{Titre}', name: 'app_titre')]
    public function getTitre($Titre):Response
    {
        return $this->render('club/detail.html.twig', [
        'Titre'=>$Titre
        ]);
    ...
    */
    #[Route('/participer', name: 'app_titre')]
    public function getTitre():Response
    {
        return $this->render('club/detail.html.twig');
    }
